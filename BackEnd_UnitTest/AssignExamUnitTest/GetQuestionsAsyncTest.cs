...
namespace Backend_UnitTest.AssignExamTests
{
    public class GetQuestionsAsync_UTCID_Tests
    {
        ...
        // UTCID01 – teacherId=1, subjectCode="MAE", chapterId=10, difficulty=2 -> list có dữ liệu
        ...
        // UTCID02 – teacherId=1, subjectCode=null, chapterId=10, difficulty=2 -> list có dữ liệu
        ...
        // UTCID03 – teacherId=1, subjectCode=" MAE" (có space), chapterId=10, difficulty=2 -> Trim, list có dữ liệu
        ...
        // UTCID06 – teacherId=999 (không tồn tại/inactive), subjectCode="MAE", chapterId=10, difficulty=2 -> KeyNotFoundException
        ...
        // UTCID07 – teacherId=1, subjectCode="MAE", chapterId=null, difficulty=null -> list có dữ liệu
        ...
        // UTCID08 – teacherId=1, subjectCode="MAE", chapterId=10, difficulty=3 (không có data) -> danh sách rỗng
